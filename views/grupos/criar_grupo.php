<section id="criar-grupo" class="new-page">
	
	<style>.icones-dropdown .dropdown-content {max-height:  350px;}</style>

	<div class="row nav z-depth-1 teal valign-wrapper">
		<div class="col s12 center">
			<a class="back valign-wrapper left" onclick="hidePage('#criar-grupo')"><i class="material-icons white-text small">chevron_left</i></a>
			<span class="title">Criar Grupo</span>
		</div>
	</div>

	<div class="container content">
		<form id="form-criar-grupo" class="col s12">

			<div class="row">
				<div class="input-field col s12">
					<input type="text" id="nome_criar_grupo" name="nome" class="charCounter" data-length="20" maxlength="20">
					<label for="nome_criar_grupo">Nome do Grupo</label>
				</div>
			</div>

			<div class="row icones-dropdown">
				<div class="input-field col s12">
					<select id="icone_criar_grupo" class="icons" name="icone">
			...
			<div class="row">
				<div class="input-field col s12 center">
					<button id="btn-criar-grupo" class="btn teal waves-effect waves-light" type="button">Criar Grupo</button>
				</div>
			</div>
